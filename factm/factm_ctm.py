# Function to Create a Correlated Topic Model Class

# This function defines a class that defines and fits a Correlated Topic Model class. 
# It includes separate classes for each necessary node, 
# with functionality for updating their variational parameters 
# and computing the corresponding terms from the Evidence Lower Bound (ELBO).
# In FACTM, it may be used multiple times.
