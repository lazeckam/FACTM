# Class Wrapper for Factor Analysis and Correlated Topic Model (FACTM)

# This class provides an easy interface for fitting the FACTM model, 
# including functionalities for pretraining, removing latent factors with low explained variance, 
